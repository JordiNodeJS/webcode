...
export default function BriefingPage() {
  return (
    <div className="min-h-screen">
      ...
      <section className="relative pt-24 pb-20 md:pb-32 overflow-hidden bg-[image:radial-gradient(circle_384px_at_75%_0%,rgb(var(--primary-rgb)_/_0.04),transparent),radial-gradient(circle_384px_at_25%_100%,rgb(var(--accent-rgb)_/_0.04),transparent),linear-gradient(to_bottom_right,rgb(var(--primary-rgb)_/_0.10),var(--background),rgb(var(--accent-rgb)_/_0.10))]">
