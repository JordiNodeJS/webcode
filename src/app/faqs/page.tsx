        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="mt-20 prose prose-lg dark:prose-invert max-w-none">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              En <strong>WEBCODE</strong>, nos especializamos en ofrecer soluciones de <strong>desarrollo web profesional</strong> para freelancers, PYMEs y startups en <strong>Barcelona</strong> y toda España. Nuestro equipo utiliza las 
              tecnologías más avanzadas de 2025, incluyendo <strong>Next.js 15</strong>, <strong>React 19</strong>, y <strong>TypeScript</strong>, para crear sitios web de alto rendimiento que destacan en los motores de búsqueda.
            </p>
            <p className="text-muted-foreground leading-relaxed mb-4">
              Desde <strong>landing pages optimizadas</strong> hasta <strong>tiendas online completas</strong> y <strong>aplicaciones web personalizadas</strong>, cada proyecto se desarrolla con un enfoque en el <strong>rendimiento</strong>, la <strong>accesibilidad</strong> y el <strong>SEO</strong>. Nuestro 
