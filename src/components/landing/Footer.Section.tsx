...
import { linkVariants, iconButtonVariants } from "@/lib/variants";
...
export function FooterSection() {
  ...
  return (
    <footer className="relative bg-card/90 backdrop-blur-xl border-2 border-primary/20 shadow-xl">
      {/* Fondo con gradiente sutil verdoso - MEJORADO PARA LEGIBILIDAD */}
      <div className={`absolute inset-0 ${styles.footerVerdosoOverlay}`}></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-center">
          ...
          <div className="text-center lg:text-right space-y-6">
            ...
            <div className="flex justify-center lg:justify-end space-x-4 pt-4">
              ...
              {/* Twitter icon intentionally hidden */}
            </div>
          </div>
        </div>
