  ...
  if (formStatus === "success") {
    return (
      <div className="text-center py-8 space-y-4">
        ...
        <h3 className="text-2xl font-semibold text-foreground">¡Mensaje enviado!</h3>
    ...
    <Card className="relative border-gray-200 dark:border-gray-800 rounded-2xl p-0 overflow-hidden">
      ...
      <CardFooter className="p-4 md:p-6 bg-muted/30 rounded-b-2xl">
        <div className="w-full">
          <h4 className="text-sm font-medium text-foreground mb-2">Compromiso de privacidad</h4>
