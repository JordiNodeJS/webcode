...
```css
--font-sans: Poppins /* Texto general y cuerpo */ --font-display: Space Grotesk
  /* Títulos y elementos destacados */ --font-serif: Lora
  /* Textos largos y citas */ --font-mono: Fira Code
